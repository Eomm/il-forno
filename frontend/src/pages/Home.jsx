    ...
    <div className="min-h-screen bg-bakery-cream">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-bakery-choco mb-4">
            Benvenuti a Il Forno
          </h1>
          <p className="text-xl text-bakery-brown">
            Sistema di gestione per il vostro panificio
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          >
            <div className="text-center">
              <h2 className="text-2xl font-bold text-bakery-choco mb-3">
                Gestione Pane
              </h2>
              <p className="text-bakery-brown">
                Gestisci i tipi di pane e i prezzi
              </p>
            </div>
          </Link>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-bakery-brown">
                Visualizza e modifica i clienti
              </p>
            </div>
          </Link>
